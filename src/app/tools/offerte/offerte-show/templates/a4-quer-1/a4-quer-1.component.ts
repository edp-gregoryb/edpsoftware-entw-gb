...
@Component({
  selector: 'app-a4-quer-1',
  templateUrl: './a4-quer-1.component.html',
  styleUrls: ['./a4-quer-1.component.css']
})
export class A4Quer1Component implements OnInit {

  totalpreis:any = [];
  pzgptotal:any = [];
  valuevonWR:any;
  //pagebreake:boolean = false;
  constructor() { }
