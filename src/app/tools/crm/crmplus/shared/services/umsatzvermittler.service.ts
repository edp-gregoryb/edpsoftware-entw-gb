...
@Injectable()
export class UmsatzvermittlerService {
  ...
  showumsatzvermittler(umsatz) {
      
      let body = '{"request":{"filter":"restitumsatzverm%04Termid%05' + this.loginparameter.logintermid + '%06sprache%05' + this.loginparameter.loginsprache + '%06sicht%05' + umsatz.sicht + '%06vondatum%05' + umsatz._datumvon + '%06bisdatum%05' + umsatz._datumbis + '%06s-kunde%05' + umsatz.kunde + '%06s-vermittler%05' + umsatz.vermittler + '%06s-objekt' +
  ...
  private extractData(res:Response){
     ...
     let result2 = resultJson2.tt_itumsatzverm;
