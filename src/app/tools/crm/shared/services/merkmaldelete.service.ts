...
@Injectable()
export class MerkmaldeleteService {
  ...
  constructor(private http: HttpClient, private loginparameterService:LoginparameterService) {
   ...
   deleteMerkmal(beznr,mkmart,mkmerk1,mkmerk2,mkmerk3){

    let body = '{"request":{"filter":"restitdelmerkmal%04Termid%05'+this.loginparameter.logintermid+'%06sprache%05'+this.loginparameter.loginsprache+'%06beznr%05'+beznr+'%06mkmart%05'+mkmart+
    ...
    let jsonbase64 = this.loginparameterService.stringtobase64(jsondata);
     //let body = '{"request":{"filter":"restitdelmerkmal%04'+jsonbase64+'"}}';            
