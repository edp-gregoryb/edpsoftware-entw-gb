...
loginparameter:any;
  constructor(private http: HttpClient, private loginparameterService:LoginparameterService) {
   ...
   getMitarbeiter(){
    ...
    '%06sicht%05A%06firma%05'+this.loginparameter.loginfirma+'"}}';

    let jsondata = 'Termid%05'+this.loginparameter.logintermid+'%06sprache%05'+this.loginparameter.loginsprache+
    '%06sicht%05A%06firma%05'+this.loginparameter.loginfirma;
     let jsonbase64 = this.loginparameterService.stringtobase64(jsondata);
     //let body = '{"request":{"filter":"restitgetmitarbeiter%04'+jsonbase64+'"}}';
...
//     let result2 = resultJson2.tt_itgetmitarbeiter;
