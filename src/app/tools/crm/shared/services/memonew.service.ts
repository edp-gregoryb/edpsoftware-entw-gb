...
export class MemonewService {
  ...
  newMemo(rapnr, text) {
    let body = '{"request":{"filter":"restitmemonew%04Termid%05' + this.loginparameter.logintermid + '%06sprache%05' + this.loginparameter.loginsprache + '%06rapnr%05' + rapnr + '%06firma%05' + this.loginparameter.loginfirma + '%06' +
      'aufnr%05%06sujetnr%05%06objekt%05%06text%05' + text + '"}}';
    ...
    let jsonbase64 = this.loginparameterService.stringtobase64(jsondata);
     //let body = '{"request":{"filter":"restitmemonew%04'+jsonbase64+'"}}';
